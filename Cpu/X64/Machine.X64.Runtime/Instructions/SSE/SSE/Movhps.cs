...
{
    private void movhps(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Movhps_m64_xmm:
                {
            ...
            case Code.Movhps_xmm_m64:
                {
                    Vector64<float> vec = this.Memory.ReadBinaryVector64(GetMemOperand64(in instruction));
