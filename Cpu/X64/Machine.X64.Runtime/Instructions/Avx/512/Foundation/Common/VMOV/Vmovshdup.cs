...
{
    private void vmovshdup(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vmovshdup_xmm_k1z_xmmm128:
                {
            ...
            case Code.EVEX_Vmovshdup_ymm_k1z_ymmm256:
                {
            ...
            case Code.EVEX_Vmovshdup_zmm_k1z_zmmm512:
                {
