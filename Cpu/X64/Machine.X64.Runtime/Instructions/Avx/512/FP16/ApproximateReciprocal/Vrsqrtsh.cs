...
{
    private void vrsqrtsh(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vrsqrtsh_xmm_k1z_xmm_xmmm16:
                {
                    ...
                    result = result.WithElement(0, Half.ReciprocalSqrtEstimate(vec[0]));
