...
{
    private void cmovae(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Cmovae_r16_rm16:
                {
                    if (local_Condition())
        ...
        {
            return !this.ProcessorRegisters.RFlagsCF;
        }
    }
}
