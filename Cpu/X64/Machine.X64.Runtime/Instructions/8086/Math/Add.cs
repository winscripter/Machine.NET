...
{
    private void add(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Add_AL_imm8:
                {
