...
{
    private void vrsqrtph(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vrsqrtph_xmm_k1z_xmmm128b16:
                {
                    ...
                    {
                        result = result.WithElement(i, Half.ReciprocalSqrtEstimate(vec[i]));
                    }
