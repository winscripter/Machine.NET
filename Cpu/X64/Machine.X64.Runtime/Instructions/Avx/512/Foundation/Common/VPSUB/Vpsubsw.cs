...
{
    private void vpsubsw(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vpsubsw_xmm_k1z_xmm_xmmm128:
                {
            ...
            case Code.EVEX_Vpsubsw_ymm_k1z_ymm_ymmm256:
                {
            ...
            case Code.EVEX_Vpsubsw_zmm_k1z_zmm_zmmm512:
                {
