...
{
    private void Vfnmsub132pd(in Instruction instruction)
    {
        switch (instruction.Code)
        {
                case Code.EVEX_Vfnmsub132pd_xmm_k1z_xmm_xmmm128b64:
                {
                ...
                case Code.EVEX_Vfnmsub132pd_ymm_k1z_ymm_ymmm256b64:
                {
                ...
                case Code.EVEX_Vfnmsub132pd_zmm_k1z_zmm_zmmm512b64_er:
                {
