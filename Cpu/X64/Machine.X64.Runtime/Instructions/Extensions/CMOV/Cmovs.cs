...
{
    private void cmovs(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Cmovs_r16_rm16:
                {
                    if (local_Condition())
        ...
        {
            return this.ProcessorRegisters.RFlagsSF;
        }
    }
}
