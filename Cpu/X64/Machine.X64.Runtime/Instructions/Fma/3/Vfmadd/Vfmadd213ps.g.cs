...
{
    private void Vfmadd213ps(in Instruction instruction)
    {
        switch (instruction.Code)
        {
                case Code.EVEX_Vfmadd213ps_xmm_k1z_xmm_xmmm128b32:
                {
                ...
                case Code.EVEX_Vfmadd213ps_ymm_k1z_ymm_ymmm256b32:
                {
                ...
                case Code.EVEX_Vfmadd213ps_zmm_k1z_zmm_zmmm512b32_er:
                {
