...
{
    private void sbb(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Sbb_AL_imm8:
                {
