...
{
    private void vsubpd(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vsubpd_xmm_k1z_xmm_xmmm128b64:
                {
            ...
            case Code.EVEX_Vsubpd_ymm_k1z_ymm_ymmm256b64:
                {
            ...
            case Code.EVEX_Vsubpd_zmm_k1z_zmm_zmmm512b64_er:
                {
