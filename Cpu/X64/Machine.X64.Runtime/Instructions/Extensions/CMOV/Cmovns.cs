...
{
    private void cmovns(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Cmovns_r16_rm16:
                {
                    if (local_Condition())
        ...
        {
            return !this.ProcessorRegisters.RFlagsPF;
        }
    }
}
