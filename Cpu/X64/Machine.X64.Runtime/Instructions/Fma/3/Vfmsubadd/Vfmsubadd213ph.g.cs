...
{
    private void Vfmsubadd213ph(in Instruction instruction)
    {
        switch (instruction.Code)
        {
                case Code.EVEX_Vfmsubadd213ph_xmm_k1z_xmm_xmmm128b16:
                {
                ...
                case Code.EVEX_Vfmsubadd213ph_ymm_k1z_ymm_ymmm256b16:
                {
                ...
                case Code.EVEX_Vfmsubadd213ph_zmm_k1z_zmm_zmmm512b16_er:
                {
