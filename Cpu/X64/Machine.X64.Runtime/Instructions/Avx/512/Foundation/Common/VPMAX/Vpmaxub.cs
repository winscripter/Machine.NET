...
{
    private void vpmaxub(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vpmaxub_xmm_k1z_xmm_xmmm128:
                {
            ...
            case Code.EVEX_Vpmaxub_ymm_k1z_ymm_ymmm256:
                {
            ...
            case Code.EVEX_Vpmaxub_zmm_k1z_zmm_zmmm512:
                {
