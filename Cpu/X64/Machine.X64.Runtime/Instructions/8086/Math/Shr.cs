...
{
    private void shr(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Shr_rm16_1:
                {
