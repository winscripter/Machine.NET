            ...
            case Code.EVEX_Vbroadcasti32x2_zmm_k1z_xmmm64:
                {
                    if (instruction.GetOpKind(1) == OpKind.Memory)
                    {
                        ...
                        uint value5 = Memory.ReadUInt32(GetMemOperand64(instruction) + 16);
                        uint value6 = Memory.ReadUInt32(GetMemOperand64(instruction) + 20);
                        uint value7 = Memory.ReadUInt32(GetMemOperand64(instruction) + 24);
                        uint value8 = Memory.ReadUInt32(GetMemOperand64(instruction) + 28);
