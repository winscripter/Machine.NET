...
{
    private void Vfmadd132ph(in Instruction instruction)
    {
        switch (instruction.Code)
        {
                case Code.EVEX_Vfmadd132ph_xmm_k1z_xmm_xmmm128b16:
                {
                ...
                case Code.EVEX_Vfmadd132ph_ymm_k1z_ymm_ymmm256b16:
                {
                ...
                case Code.EVEX_Vfmadd132ph_zmm_k1z_zmm_zmmm512b16_er:
                {
