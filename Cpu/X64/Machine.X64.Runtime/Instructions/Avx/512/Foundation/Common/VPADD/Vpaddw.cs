...
{
    private void vpaddw(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_Vpaddw_xmm_k1z_xmm_xmmm128:
                {
            ...
            case Code.EVEX_Vpaddw_ymm_k1z_ymm_ymmm256:
                {
            ...
            case Code.EVEX_Vpaddw_zmm_k1z_zmm_zmmm512:
                {
