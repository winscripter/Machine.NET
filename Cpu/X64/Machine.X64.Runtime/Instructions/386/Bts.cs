...
{
    private void bts(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Bts_rm16_imm8:
                {
                    ...
                    ushort altered = BitUtilities.One(rm16, imm8);
            ...
            case Code.Bts_rm16_r16:
                {
                    ...
                    ushort altered = BitUtilities.One(rm16, r16);
            ...
            case Code.Bts_rm32_r32:
                {
                    ...
                    ushort altered = BitUtilities.One(rm32, r32);
            ...
            case Code.Bts_rm64_r64:
                {
                    ...
                    ushort altered = BitUtilities.One(rm64, r64);
