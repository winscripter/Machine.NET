...
{
    private void cmovbe(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Cmovbe_r16_rm16:
                {
                    if (local_Condition())
        ...
        {
            return (this.ProcessorRegisters.RFlagsCF || this.ProcessorRegisters.RFlagsZF);
        }
    }
}
