...
{
    private void cmovne(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.Cmovne_r16_rm16:
                {
                    if (local_Condition())
        ...
        {
            return !this.ProcessorRegisters.RFlagsZF;
        }
    }
}
