...
{
    private void Vfnmadd213sh(in Instruction instruction)
    {
        switch (instruction.Code)
        {
                case Code.EVEX_Vfnmadd213sh_xmm_k1z_xmm_xmmm16_er:
                {
                    ...
                    result = result.WithElement(0, (src2[0] * src1[0]) + result[0]);
