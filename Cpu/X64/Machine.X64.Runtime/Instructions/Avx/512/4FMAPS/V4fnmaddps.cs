...
{
    private void v4fnmaddps(in Instruction instruction)
    {
        switch (instruction.Code)
        {
            case Code.EVEX_V4fnmaddps_zmm_k1z_zmmp3_m128:
                {
                    ...
                    Vector512<float> c = this.Memory.ReadBinaryVector512(GetMemOperand64(in instruction));
